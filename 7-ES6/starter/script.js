...
function driversLicence5(passedTest){
    ...
    // if block, ES5 is allowed to access
    console.log(firstName + ', born in ' + yearOfBirth + ' is now officially allowed to drive a car.');
}
// function block, ES5 is allowed to access
//console.log(firstName + ', born in ' + yearOfBirth + ' is now officially allowed to drive a car.');
...
function driversLicence6(passedTest){
    if (passedTest){
        // ES6 does not allow this kind of Hoist.
        //console.log(firstName);
        let firstName = 'John';
...
const [age, retirement] = caclAgeRetirement(1990);
...
const familyMiler = ['Marry', 'Bob', 'Ann'];
...
const boxes = document.querySelectorAll('.box');
const all = [h, ...boxes];
all.forEach(cur => cur.style.color = 'purple');   // My Opinion
...
question.set('question', 'What is the official name of the lasteste major JavaScript version?');
question.set(1, 'ES5');
question.set(2, 'ES6');
...
class Park extends Element{
    ...
    calcDensity(){
        let density = Math.round(this.numTree / this.parkArea, 2);
...
(function(streets){
    ...
    console.log(sum, sum/streets.length);
})(allStreets);                   
*/
